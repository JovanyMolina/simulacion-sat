    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-[#8a1538] text-white p-3">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <Link href="/gobierno" className="hover:underline">Gobierno</Link>
      ...
      <div className="bg-gray-100 py-2 px-4">
        <div className="container mx-auto">
          <div className="flex items-center text-sm">
            ...
            <Link href="/tramite" className="hover:underline">Trámite</Link>
            <span className="mx-2">›</span>
            <span>Inicio</span>
          </div>
        </div>
      ...
      <main className="flex-grow bg-white py-8">
        <div className="container mx-auto px-4 max-w-3xl">
          <h1 className="text-2xl font-medium text-gray-700 mb-8">Acceso con e.firma</h1>
          ...
          <div className="mt-12 bg-blue-50 border border-blue-100 p-6 text-sm text-gray-700">
            <h2 className="text-center mb-4 text-blue-700 font-medium">Aviso de privacidad simplificado</h2>
            <p className="text-center mb-4">
              ...
              (<a href="https://www.sat.gob.mx" className="text-blue-700 hover:underline">https://www.sat.gob.mx</a>)
              los cuales son protegidos conforme a lo dispuesto en la Ley General de Protección de Datos Personales en Posesión de Sujetos Obligados y la normatividad que resulte aplicable.
            </p>
            <p className="text-center">
              Para mayor información acerca de este tema y de los derechos que puedes hacer valer, ponemos a tu disposición el Aviso de privacidad en el sitio: 
              <a href="https://repositorio.cloudb.sat.gob.mx/FTP/avisoprivacidad/802_NV_aviso_integral.html" className="text-blue-700 hover:underline"> https://repositorio.cloudb.sat.gob.mx/FTP/avisoprivacidad/802_NV_aviso_integral.html</a>
            </p>
          </div>
        </div>
      </main>
